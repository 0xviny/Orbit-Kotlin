...
class OrbitSlashCommandDeclarationBuilder(
    val name: String,
    ...
    fun subCommandGroup(
        ...
        description: String,
        baseName: String,
        block: OrbitSlashCommandGroupBuilder.() -> Unit
    ) {
        val group = OrbitSlashCommandGroupBuilder(name, description)
        group.block()
        this.baseName = baseName
    ...
    fun getSubCommandGroup(name: String): OrbitSlashCommandGroupBuilder? {
